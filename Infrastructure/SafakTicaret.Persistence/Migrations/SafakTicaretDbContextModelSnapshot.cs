...
namespace SafakTicaret.Persistence.Migrations
{
    ...
    partial class SafakTicaretDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Endpoint", null)
                        .WithMany()
                        .HasForeignKey("EndpointsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SafakTicaret.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Basket", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Identity.AppUser", "User")
                        .WithMany("Baskets")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.BasketItem", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Basket", "Basket")
                        .WithMany("BasketItems")
                        .HasForeignKey("BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SafakTicaret.Domain.Entities.Product", "Product")
                        .WithMany("BasketItems")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.CompletedOrder", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Order", "Order")
                        .WithOne("CompletedOrder")
                        .HasForeignKey("SafakTicaret.Domain.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("SafakTicaret.Domain.Entities.Order", b =>
                {
                    b.HasOne("SafakTicaret.Domain.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("SafakTicaret.Domain.Entities.Order", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
